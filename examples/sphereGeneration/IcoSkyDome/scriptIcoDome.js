...
class App {
	...
	loadResources() {
		...
		this.textureLoader.load("../../common/textures/sunset.jpg", (image) => {
			...
			this.instanceOfClassSkyDome = new RC.SkyDome(this.texture, this.camera, 20, 1, new RC.Color(1,1,1), 1, undefined);

			/*
			this.instanceOfClassSkyDome.GetScene.add(this.instanceOfClassSkyDome.GetCamera);
			this.instanceOfClassSkyDome.GetScene.add(this.instanceOfClassSkyDome.GetMySkyDome);
			...
			d3Light.position = new RC.Vector3(0,0,1);
			this.instanceOfClassSkyDome.GetScene.add(d1Light);
			this.instanceOfClassSkyDome.GetScene.add(d2Light);
			this.instanceOfClassSkyDome.GetScene.add(d3Light);

			this.camera = this.instanceOfClassSkyDome.GetCamera;
			*/
